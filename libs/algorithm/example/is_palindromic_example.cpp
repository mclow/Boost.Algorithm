...
int main ( int /*argc*/, char * /*argv*/ [] )
{
    ...
    if(ba::is_palindromic(vec.begin(), vec.end()))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;


    //Of course, you can use const iterators
    if(ba::is_palindromic(vec.cbegin(), vec.cend()))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;
    ...
    if(ba::is_palindromic(list.begin(), list.end()))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;
    ...
    if(ba::is_palindromic(vec.begin(), vec.end(), lambdaComparator))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;

    if(ba::is_palindromic(vec.begin(), vec.end(), funcComparator<int>))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;

    if(ba::is_palindromic(vec.begin(), vec.end(), functorComparator()))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;

    if(ba::is_palindromic(vec.begin(), vec.end(), objFunc))
        std::cout << "This container is palindromic" << std::endl;
    else
        std::cout << "This container is not palindromic" << std::endl;
